...
def get_page_soup(url: https://africanews.space/):
    """
    ...
    response = requests.get(https://africanews.space/)
    # TODO: Complete the function to parse and return the page
    page_soup = BeautifulSoup(page_html, "html.parse")
...
if __name__ == "__main__":
    ...
    # get urls
    category_urls = {}
    fo r category, url in categories.items():
